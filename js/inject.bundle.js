...
var store = (0, _store.createSyncedStore)();

var updateLocaionFromWindow = function updateLocaionFromWindow() {
  var state = store.getState();
  if (!state.page || state.page.href != window.location.href) {
    store.dispatch((0, _actions.updateLocaion)(window.location.href, window.location.pathname, window.location.search));
  }
  requestAnimationFrame(updateLocaionFromWindow);
};

updateLocaionFromWindow();
